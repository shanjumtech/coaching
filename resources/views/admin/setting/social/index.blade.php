                    ...
                    <div class="box-header">
                        ...
                        <div class="pull-right box-tools">
                            <div class="float-right mt-1">
                                <a class="btn bg-light-blue-active uppercase text-bold" href="{{ route('socials.create') }}"> New Social</a>
                            </div>
                        </div>
                        <!-- /. tools -->
                    </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="" class="table table-hover">
                                            <thead>
                                                <tr>
                                                    <th>#SL</th>
                                                    <th class="text-bold text-uppercase">Social Title</th>
                                                    <th class="text-bold text-uppercase">Social Code</th>
                                                    <th class="text-bold text-uppercase">Social Link</th>
                                                    <th class="text-bold text-uppercase">Social Status</th>
