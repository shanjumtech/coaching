                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-bold text-uppercase">Class</th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-sm btn-info fa fa-eye" href="{{ route('order-pdf',$order->id) }}" title="Show"></a>
                                             <select name="status" class="form-select pl-4" aria-label="Default select example" data-order-id="{{ $order->id }}">
    ...
    $(document).ready(function() {
        $('select[name="status"]').on('change', function() {
            ...
            if (orderId) {
                ...
                $.ajax({
                    url: "{{  url('/update-order-status') }}/" + orderId
                    , type: "GET"
                    , dataType: "json"
                    , data: {
                        status: status
